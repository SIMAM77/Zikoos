...
<html>
    ...
    <body>
        ...
        <section class="groupe1 clearfix">
                ...
                <h3><?=$row['band']?></h3>
                    <p><?=$row['commentaire']?></p>
                <div class="renvoi"><a href="instruments.php?id=<?=$row['id']?>">
                Voir les intruments</a></div>
                </article>
           </section>
           <ul>
                <li><a href="delete.php?id=<?=$row['id']?>">Supprimer</a></li>
                <li><?php if($row['visible'] == 0){?>
                <a href="switch.php?id=<?=$row['id']?>">Afficher</a>
                <li><?php } else {?></li>
                <a href="switch.php?id=<?=$row['id']?>">Cacher</a>
                <?php } ?></li>
           </ul>
        <?php endwhile; ?>
        <footer>
